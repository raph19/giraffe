...
{counter_cube += 1;
  ...
  const cubeMat = new THREE.MeshStandardMaterial({side: THREE.DoubleSide});
...
{counter_tetrahedron+=1;
  ...
  const tetra = new THREE.MeshStandardMaterial({side:THREE.DoubleSide});
...
{counter_sphere+=1;
  ...
  const sphereMat = new THREE.MeshStandardMaterial({side:THREE.DoubleSide});
...
const cylindermat = new THREE.MeshStandardMaterial( {side:THREE.DoubleSide} );
