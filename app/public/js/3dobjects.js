...
document.getElementById("image").onclick = function() {document.getElementById("model-input").style.display="none";if(uploaded_image!=null){createImage()}else{document.getElementById("image-input").style.display="inline-grid";}};
document.getElementById("model").onclick = function() {document.getElementById("model-input").style.display="inline-grid";document.getElementById("image-input").style.display="none"};
...
{counter_cube += 1;
  ...
  const cubeMat = new THREE.MeshStandardMaterial({color: 'white',side: THREE.DoubleSide});
...
{counter_tetrahedron+=1;
  ...
  const tetra = new THREE.MeshStandardMaterial({color: 'white',side:THREE.DoubleSide});
...
{counter_sphere+=1;
  ...
  const sphereMat = new THREE.MeshStandardMaterial({color: 'white',side:THREE.DoubleSide});
...
const cylindermat = new THREE.MeshStandardMaterial( {color: 'white',side:THREE.DoubleSide} );
