...
{counter_tetrahedron+=1;
  ...
  const tetra = new THREE.MeshStandardMaterial({color: 'grey',side:THREE.DoubleSide});
...
{counter_sphere+=1;
  ...
  const sphereMat = new THREE.MeshStandardMaterial({color: 'grey',side:THREE.DoubleSide});
...
const cylindermat = new THREE.MeshStandardMaterial( {color: 'grey',side:THREE.DoubleSide} );
